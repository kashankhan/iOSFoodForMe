...
class FFMEvaluationRecipeTableViewController:  UITableViewController , ENSideMenuDelegate , NSFetchedResultsControllerDelegate {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let identifierCell = "IdentifierFFMEvaluationRecipeTableViewCell"
        ...
        if segue.identifier == "IdentifierSegueShowRecipeDetail" {
            ...
            if let indexPath = tableView.indexPathForSelectedRow() {
                let object =  ((self.searchDisplayController?.active) == true) ?
                    self.searchResult?.objectAtIndex(indexPath.row) as! Recipe :self.fetchedResultsController.entityAtIndexPath(indexPath)
                (segue.destinationViewController as! FFMEvaluationRecipeDetailTableViewController).recipe = object
            }
        }
    }
